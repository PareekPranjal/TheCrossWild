...
const products = [
  {
    ...
    description:
      "Promote your brand with customized promotional mugs available in various designs, shapes, and price ranges—tailored to your requirements.",
  },
  {
    id: 2,
    name: "Printed/Printed-Customised-mug.jpg",
    image: "/images/products/Mugs/Printed-Customised-mug.jpg",
    description:
      "Printed and customized mugs available in a wide range of designs, patterns, and colors—personalize with your picture, logo, or name as per requirement.",
  },
  {
    id: 3,
    name: "Coffee Mug",
    image: "/images/products/Mugs/Coffee-Mug.jpg",
    description:
      "Customized coffee mugs in various styles, sizes, and colors—high quality, affordable, and tailored to your needs.",
  },
  {
    id: 4,
    name: "Corporate Mug",
    image: "/images/products/Mugs/Corporate-Mug.jpg",
    description:"Premium ceramic mugs available in bulk—ideal for corporate needs with free quotes on request.",
  },
  {
    id: 5,
    name: "Plain Mug",
    image: "/images/products/Mugs/Plain-Mug.jpg",
    description:
      "Enjoy your favorite brew with customizable plain mugs—available in bulk with free quotes on request.",
  },
];
...
<section className="bg-gradient-to-r from-green-600 to-blue-600 px-6 py-16 text-center">
  <div className="mx-auto max-w-4xl">
    <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl">
      Personalized Custom Mug Printing in Jaipur - The Cross Wild
    </h1>
    <p className="mt-6 text-lg leading-relaxed text-gray-700">
      Most people start their day with morning tea, but many love to drink tea in their favorite mug. 
      A beautifully printed coffee mug does not only add beauty to the office or home space but can also 
      be used as both a paperweight and holder. With{" "}
      <span className="font-semibold">The Cross Wild</span>, you get premium customized mugs where we can 
      print logos, photos, designs, or even inspirational quotes — making them the perfect gift or 
      corporate accessory.
    </p>
  </div>
</section>
...
<section className="bg-white px-6 py-16">
  <div className="mx-auto max-w-5xl text-center">
    <h2 className="mb-6 text-3xl font-bold text-gray-900">
      Why Choose The Cross Wild for Mug Printing?
    </h2>
    <p className="mb-8 text-lg leading-relaxed text-gray-700">
      At <span className="font-semibold">The Cross Wild</span>, we specialize in creating 
      high-quality mugs that stand out. From{" "}
      <span className="font-semibold">promotional mugs</span> to{" "}
      <span className="font-semibold">corporate mugs</span> and personalized gifts, 
      our advanced printing technology ensures perfection in every piece. 
      Whether raw, solid, neon, or pale colors — your imagination, we print.
    </p>
    ...
    <div className="grid grid-cols-1 gap-6 text-left sm:grid-cols-2 md:grid-cols-3">
      <div className="rounded-xl bg-gray-50 p-6 shadow">
        <h3 className="mb-2 font-semibold text-gray-900">Lightweight</h3>
        <p className="text-sm text-gray-600">
          Easy to carry, designed for daily use without compromising quality.
        </p>
      </div>
      <div className="rounded-xl bg-gray-50 p-6 shadow">
        ...
        <p className="text-sm text-gray-600">
          Durable and safe for everyday use at home or office.
        </p>
      </div>
      <div className="rounded-xl bg-gray-50 p-6 shadow">
        <h3 className="mb-2 font-semibold text-gray-900">
        ...
        <p className="text-sm text-gray-600">
          Thick material ensures your tea or coffee stays warm longer.
        </p>
      </div>
    </div>
  </div>
