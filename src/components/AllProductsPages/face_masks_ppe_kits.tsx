...
const products = [
  {
    id: 1,
    name: "Face Mask",
    image: "/images/products/FaceMaskPPE/Face-Mask.jpg",
    description:
      "Durable, comfortable, and customizable face masks for daily use and promotions.",
  },
  {
    id: 2,
    name: "PPE Kit",
    image: "/images/products/FaceMaskPPE/PPE-Kit.jpg",
    description:
      "Protective, high-quality PPE kits designed for safety and comfort.",
  },
];
...
export default function ProductsPage() {
  ...
  <div className="mx-auto max-w-4xl">
    <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl">
      Face Mask And PPE Kit Manufacturer & Wholesaler
    </h1>
    <p className="mt-6 text-lg leading-relaxed text-gray-700">
      We understand how important it is today to cover your face and body with
      protective masks and PPE kits, especially if you’re working in healthcare
      sectors.{" "}
      <span className="font-semibold">Cross Wild</span> brings you a wide
      collection of premium Face Masks and PPE Kits made from high-quality
      materials to safeguard you and your family from COVID-19.
    </p>
  </div>
</section>
      ...
      <section className="px-6 py-16">
        <div className="container mx-auto">
          <h2 className="mb-12 text-center text-3xl font-bold text-gray-900">
            Our Face Mask and PPE Kits Collection
          </h2>
...
<section className="bg-white px-6 py-16">
  <div className="mx-auto max-w-5xl text-center">
    <h2 className="mb-6 text-3xl font-bold text-gray-900">
      Why Choose Cross Wild?
    </h2>
    <p className="mb-8 text-lg leading-relaxed text-gray-700">
      As one of the leading <span className="font-semibold">PPE Kit and Face Mask 
      Manufacturers in Jaipur</span>, we ensure safety with world-class materials 
      and advanced production standards. Whether you need N95 masks, PPE kits for 
      hospitals, clinics, or bulk supplies, Cross Wild is your trusted partner for 
    ...
    <div className="grid grid-cols-1 gap-6 text-left sm:grid-cols-2 md:grid-cols-4">
      <div className="rounded-xl bg-gray-50 p-6 shadow">
        ...
        <p className="text-sm text-gray-600">
          High-quality N95 masks designed to provide maximum protection for 
          healthcare workers and individuals.
        </p>
      </div>
      <div className="rounded-xl bg-gray-50 p-6 shadow">
        <h3 className="mb-2 font-semibold text-gray-900">
          Top PPE Kit Manufacturer
        </h3>
        <p className="text-sm text-gray-600">
          Wide range of PPE kits for hospitals, clinics, salons, and personal use.
        </p>
      </div>
      <div className="rounded-xl bg-gray-50 p-6 shadow">
        <h3 className="mb-2 font-semibold text-gray-900">
        ...
        <p className="text-sm text-gray-600">
          Manufactured with international safety standards to protect against 
      ...
      <div className="rounded-xl bg-gray-50 p-6 shadow">
        ...
        <p className="text-sm text-gray-600">
          Get wholesale Face Masks and PPE Kits delivered anywhere in India.
        </p>
      </div>
    </div>
  </div>
