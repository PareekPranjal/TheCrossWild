...
const products = [
  {
    ...
    image: "/images/products/Sanitizer/Thermometer.jpg",
    description:
      "Accurate, contactless infrared thermometers for quick and safe temperature checks.",
  },
  {
    id: 2,
    name: "Hand Sanitizer",
    image: "/images/products/Sanitizer/Sanitizer.jpg",
    description:
      "Effective, fast-acting hand sanitizers for reliable germ protection on the go.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-green-600 to-blue-600 px-6 py-16 text-center">
        <div className="mx-auto max-w-4xl">
          <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl">
            Sanitizers & Thermometers
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-gray-700">
            At <span className="font-semibold">Cross Wild</span>, we understand
            the importance of protective healthcare essentials in today’s world.
            From
            <span className="font-semibold">
              {" "}
              Hand Sanitizers & Infrared Thermometers
            </span>
            , we ensure premium quality products at wholesale prices to keep you
      ...
      <section className="px-6 py-16">
        <div className="container mx-auto">
          <h2 className="mb-12 text-center text-3xl font-bold text-gray-900">
            Our Healthcare Products Collection
          </h2>
      ...
      <section className="bg-gray-50 px-6 py-16">
        <div className="mx-auto max-w-5xl text-center">
          <h2 className="mb-6 text-3xl font-bold text-gray-900">
            Sanitizer Wholesaler in Jaipur
          </h2>
          <p className="mb-8 text-lg leading-relaxed text-gray-700">
            Hand Sanitizers or alcohol-based sanitizers play an important role
            these days. They help you and your family stay safe from the spread
            of viruses. Whether you’re in office or travelling, sanitizers
            maintain proper hygiene as COVID-19 spreads everywhere.
          </p>
          <p className="mb-8 text-lg leading-relaxed text-gray-700">
            Many Hand Sanitizer Manufacturers in Jaipur provide sanitizers in
            different pack sizes — 50ml, 100ml, 200ml, 500ml and 1 Liter. If
            you’re a retailer and want to sell top-quality sanitizers, you can
            place bulk orders with
            <span className="font-semibold"> Cross Wild</span> and get on-time
            delivery.
          </p>
          ...
          <div className="grid grid-cols-1 gap-6 text-left sm:grid-cols-2 md:grid-cols-3">
            <div className="rounded-xl bg-white p-6 shadow">
              ...
              <p className="text-sm text-gray-600">
                Reliable sanitizers that provide effective protection against
                viruses.
              </p>
            </div>
            <div className="rounded-xl bg-white p-6 shadow">
              ...
              <p className="text-sm text-gray-600">
                Retailers can order sanitizers in wholesale with timely
                delivery.
              </p>
            </div>
            <div className="rounded-xl bg-white p-6 shadow">
              ...
              <p className="text-sm text-gray-600">
                Available in 50ml, 100ml, 200ml, 500ml and 1 Liter bottles.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white px-6 py-16">
        <div className="mx-auto max-w-5xl text-center">
          <h2 className="mb-6 text-3xl font-bold text-gray-900">
            Infrared Thermometer Wholesale in Jaipur
          </h2>
          <p className="mb-8 text-lg leading-relaxed text-gray-700">
            Infrared Thermometers are essential for organizations, healthcare
            units and industries as workplaces reopen after lockdown. They are
            the best way to check the temperature of people entering premises
            and reduce the risk of spreading COVID-19.
          </p>
          <p className="mb-8 text-lg leading-relaxed text-gray-700">
            As one of the leading{" "}
            <span className="font-semibold">
              Infrared Thermometer Wholesalers in Jaipur
            </span>
            , Cross Wild is dedicated to providing premium quality devices at
            the most affordable prices. We offer plenty of choices and options
          ...
          <div className="grid grid-cols-1 gap-6 text-left sm:grid-cols-2 md:grid-cols-3">
            <div className="rounded-xl bg-gray-50 p-6 shadow">
              <h3 className="mb-2 font-semibold text-gray-900">
                Best Quality Thermometers
              </h3>
              <p className="text-sm text-gray-600">
                Accurate, fast, and reliable devices for temperature screening.
              </p>
            </div>
            <div className="rounded-xl bg-gray-50 p-6 shadow">
              <h3 className="mb-2 font-semibold text-gray-900">
              ...
              <p className="text-sm text-gray-600">
                Bulk supply of thermometers at affordable prices in Jaipur.
              </p>
            </div>
            <div className="rounded-xl bg-gray-50 p-6 shadow">
              <h3 className="mb-2 font-semibold text-gray-900">
              ...
              <p className="text-sm text-gray-600">
                Preferred supplier for hospitals, schools, industries, and
                offices.
              </p>
            </div>
          </div>
